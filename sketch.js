...
function setup() {
	...
	rope1 = new Chain(bob1.body,{x:200,y:10})
	rope2 = new Chain(bob2.body,{x:270,y:10})
	rope3 = new Chain(bob3.body,{x:340,y:10})
	rope4 = new Chain(bob4.body,{x:410,y:10})
	rope5 = new Chain(bob5.body,{x:480,y:10})
